...
// helper to check if URL is a social media domain
...
export const Webview = ({
  ...
  }, [tab.id, tab.url, onTitleUpdate, onUrlChanged, onClose]);

  const showLoadingOverlay = isActive && isLoading && !networkError;
  const showOfflineOverlay = isActive && networkError !== null;
